...
from ...controllers.dashboard.controller import dashboard, get_data_rate, get_anomalies, delete_anomaly, toggle_read, anomaly
...
blueprint.route('/dashboard/anomaly', methods=['GET', 'POST'])(anomaly)